...
export default function TatoueurSalon({
  ...
  return (
    <>
      <article className="bg-blue-400 flex flex-col gap-4">
          ...
          {tatoueurs.map((tatoueur) => (
            ...
            >
              ...
              <div className="flex flex-col gap-2 items-center pb-4">
                ...
                <p className="text-white text-sm font-two">
                  {tatoueur.description}
                </p>
                <div className="flex gap-2">
                  <button className="text-xs cursor-pointer bg-gradient-to-l from-tertiary-400 to-tertiary-500 min-w-[100px] max-w-[100px] text-center text-white font-one py-1 px-4 rounded-[20px] hover:scale-105 transition-all ease-in-out duration-300">
                    Modifier
                  </button>
                  <button className="text-xs cursor-pointer bg-gradient-to-l from-red-700 to-red-900 min-w-[100px] max-w-[100px] text-center text-white font-one py-1 px-4 rounded-[20px] hover:scale-105 transition-all ease-in-out duration-300">
                    Supprimer
                  </button>
                </div>
              </div>
