...
export default function DeleteConversationBtn({
  ...
  return (
    <>
      ...
      >
        <MdDelete size={14} className="text-red-200 group-hover:text-red-100 transition-colors" />
      </button>
      ...
      {isOpen &&
        ...
        createPortal(
          <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-[60] flex items-center justify-center p-4">
            <div className="bg-noir-800 border border-red-500/30 rounded-2xl shadow-2xl max-w-sm w-full animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="border-t border-white/10 px-6 py-4 flex gap-3 justify-end">
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="cursor-pointer px-4 py-2 rounded-2xl bg-red-600/20 border border-red-400/60 text-red-200 hover:bg-red-600/30 hover:border-red-300 transition-all duration-200 text-sm font-one disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                >
                  {isLoading ? (
                    <>
