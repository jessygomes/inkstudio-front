        ...
        <div className="bg-noir-500 rounded-none lg:rounded-3xl w-full h-full lg:h-auto lg:max-w-5xl lg:max-h-[90vh] overflow-hidden flex flex-col border-0 lg:border lg:border-white/20 lg:shadow-2xl min-h-0">
          ...
          <div className="p-6 lg:p-4 border-b border-white/10 bg-white/5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="p-3 lg:p-2 hover:bg-white/10 rounded-full transition-colors"
              >
          ...
          <div className="flex-1 overflow-y-auto p-6 lg:p-4 min-h-0">
            ...
            >
              ...
              <div className="bg-white/5 rounded-2xl p-6 lg:p-4 border border-white/10">
                <h3 className="flex items-center gap-2 text-base lg:text-sm font-semibold text-white font-one uppercase tracking-wide mb-4 lg:mb-2">
                  <CiUser size={24} className="lg:w-5 lg:h-5" /> Informations
                  personnelles
                </h3>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-4">
                  <div className="space-y-2 lg:space-y-1">
                    ...
                    <input
                      ...
                      className="w-full p-4 lg:p-2 bg-white/10 border border-white/20 rounded-lg text-white text-base lg:text-xs focus:outline-none focus:border-tertiary-400 transition-colors"
                    />
              ...
              <div className="bg-white/5 rounded-2xl p-6 lg:p-4 border border-white/10">
                <button
                  ...
                  className="cursor-pointer w-full flex items-center justify-between mb-6 lg:mb-4"
                >
                  <h3 className="flex items-center gap-2 text-base lg:text-sm font-semibold text-white font-one uppercase tracking-wide">
                    <RiHealthBookLine size={24} className="lg:w-5 lg:h-5" />{" "}
                    Historique médical
                  ...
                  {showMedicalHistory ? (
                    <IoChevronUp className="text-white/70 w-6 h-6 lg:w-5 lg:h-5" />
                  ) : (
                    <IoChevronDown className="text-white/70 w-6 h-6 lg:w-5 lg:h-5" />
                  )}
                </button>
                ...
                {showMedicalHistory && (
                  <div className="space-y-6 lg:space-y-4">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-4">
                      <div className="space-y-2 lg:space-y-1">
                        ...
                        <textarea
                          ...
                          className="w-full p-4 lg:p-2 bg-white/10 border border-white/20 rounded-lg text-white text-base lg:text-xs focus:outline-none focus:border-tertiary-400 transition-colors resize-none"
                          rows={3}
                    ...
                    <div className="flex items-center gap-3 lg:gap-2 mt-6 lg:mt-4">
                      <input
                        {...form.register("pregnancy")}
                        type="checkbox"
                        className="w-5 h-5 lg:w-4 lg:h-4 text-tertiary-400 bg-white/10 border-white/20 rounded focus:ring-tertiary-400"
                      />
                      <label className="text-sm lg:text-xs text-white/70 font-one">
          ...
          <div className="p-6 sm:p-4 border-t border-white/10 bg-white/5 flex justify-end gap-4 sm:gap-3">
            <button
              type="button"
              onClick={() => setIsOpen(false)}
              className="cursor-pointer px-6 py-3 sm:px-4 sm:py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg border border-white/20 transition-colors font-medium font-one text-xs sm:text-sm lg:text-xs"
            >
              Annuler
            </button>
            <button
              ...
              className="cursor-pointer px-8 py-3 sm:px-6 sm:py-2 bg-gradient-to-r from-tertiary-400 to-tertiary-500 hover:from-tertiary-500 hover:to-tertiary-600 text-white rounded-lg transition-all duration-300 font-medium disabled:opacity-50 disabled:cursor-not-allowed font-one text-xs sm:text-sm lg:text-xs"
            >
              {loading
                ? existingClient
                  ? "Modification..."
