      ...
      {selectedAppointment && (
        ...
        >
          <div className="h-full w-full md:h-fit md:max-w-2xl lg:max-w-3xl lg:max-h-[90vh] bg-noir-700 md:bg-transparent rounded-none md:rounded-xl flex flex-col border-0 md:border md:border-white/10 shadow-2xl min-h-0">
            ...
            {/* Footer compact */}
            <div className="p-4 md:p-3 border-t border-white/10 bg-white/5">
              <button
                onClick={closeAppointmentDetails}
                className="cursor-pointer w-full py-3 md:py-2 text-sm md:text-xs bg-white/10 hover:bg-white/20 text-white rounded-lg border border-white/20 transition-colors font-medium font-one"
              >
                Retour à la liste
              </button>
            </div>
