              ...
              <div className="space-y-3">
                ...
                <div>
                  <div className="flex justify-between items-start">
                    <span className="text-white/60 text-xs font-one">Mode</span>
                    <span
                      className={`font-one text-xs flex items-center gap-1 ${
                  ...
                  {selectedEvent.visio && selectedEvent.visioRoom && (
                    <div className="mt-2 flex justify-end">
                      <a
                        href={selectedEvent.visioRoom}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1 px-2 py-1 bg-blue-500/20 text-blue-300 rounded-md text-xs font-one hover:bg-blue-500/30 transition-colors border border-blue-400/30"
                      >
                        <svg
                          className="w-3 h-3"
                          fill="none"
