  ...
  const plans = [
    {
      ...
      price: "29",
      period: "mois",
      description: "Idéal pour les tatoueurs indépendants qui démarrent leur activité",
    ...
    },
    {
      ...
      price: "Sur mesure",
      period: "",
      description: "Solution personnalisée pour les chaînes et franchises",
      ...
      <div className="container mx-auto px-4 sm:px-8 max-w-7xl relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/70 font-one max-w-3xl mx-auto leading-relaxed">
            Choisissez la solution qui correspond à votre salon et faites évoluer votre abonnement selon vos besoins
          </p>
        </div>
              ...
              <div className="text-center mb-8">
                <div className="flex justify-center mb-4">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center ${
                    plan.color === 'tertiary' ? 'bg-gradient-to-br from-tertiary-500/20 to-tertiary-600/20' :
                    plan.color === 'purple' ? 'bg-gradient-to-br from-purple-500/20 to-purple-600/20' :
                ...
                <h3 className="text-2xl font-bold text-white font-two mb-2">{plan.name}</h3>
                ...
                <div className="mb-4">
                  {plan.price === "Sur mesure" ? (
                    <div className="text-3xl font-bold text-white font-two">Sur mesure</div>
                  ) : (
                    <div className="flex items-baseline justify-center gap-1">
                      <span className="text-4xl font-bold text-white font-two">{plan.price}€</span>
                      <span className="text-white/60 font-one">/{plan.period}</span>
                    </div>
                  )}
                </div>
                
                <p className="text-white/70 font-one text-sm leading-relaxed">{plan.description}</p>
              </div>
                ...
                {plan.features.map((feature, featureIndex) => (
                  <div key={featureIndex} className="flex items-start gap-3">
                    <div className={`w-5 h-5 rounded-full flex items-center justify-center mt-0.5 flex-shrink-0 ${
                      ...
                      <FaCheck size={12} className={plan.popular ? 'text-tertiary-400' : 'text-white/70'} />
                    </div>
                    <span className="text-white/90 font-one text-sm">{feature}</span>
                  </div>
                ))}
              </div>

              {/* CTA */}
              <button className={`w-full py-4 px-6 rounded-2xl font-one font-semibold transition-all duration-300 hover:scale-105 ${
                plan.popular 
        ...
        <div className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl rounded-3xl p-8 sm:p-12 border border-white/10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-lg font-bold text-white font-two mb-3">Puis-je changer de formule ?</h4>
              ...
              <div>
                <h4 className="text-lg font-bold text-white font-two mb-3">Y a-t-il un engagement ?</h4>
                <p className="text-white/70 font-one text-sm leading-relaxed">
                  Aucun engagement requis. Vous pouvez annuler votre abonnement à tout moment sans frais.
                </p>
              </div>
              
              <div>
                <h4 className="text-lg font-bold text-white font-two mb-3">Le support est-il inclus ?</h4>
                <p className="text-white/70 font-one text-sm leading-relaxed">
                  Oui, tous nos plans incluent un support technique et une formation à l'utilisation.
                </p>
              </div>
              
              <div>
                <h4 className="text-lg font-bold text-white font-two mb-3">Mes données sont-elles sécurisées ?</h4>
                <p className="text-white/70 font-one text-sm leading-relaxed">
                  Toutes vos données sont chiffrées et sauvegardées quotidiennement sur des serveurs sécurisés.
                </p>
              </div>
            </div>
            ...
            <div className="text-center mt-8 p-6 bg-white/5 rounded-2xl">
              <p className="text-tertiary-400 font-one font-semibold">
                🎁 30 jours d'essai gratuit sur tous les plans - Aucune carte bancaire requise
              </p>
            </div>
          </div>
        </div>
