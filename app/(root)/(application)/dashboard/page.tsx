...
export default async function DashboardPage() {
  ...
  return (
    <div className=" bg-noir-700 flex flex-col items-center justify-center gap-4 px-3 lg:px-10 pb-10 lg:pb-0">
      <div className="flex flex-col relative gap-6 w-full mt-4 xl:mt-23">
        {/* Header */}
        <div className="">
        ...
        {/* Main Grid Layout */}
        <div className="min-h-screen grid grid-cols-12 gap-6">
